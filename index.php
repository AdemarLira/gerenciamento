...
<body>
  ...
  <div class="main_info">
    ...
    <button class="button-cadastrar" data-aos="fade-up" data-aos-delay="750" data-aos-duration="1500"
      data-aos-easing="ease-in-out" onclick="cadastrar()">Realizar cadastro</button>
    <button class="button-login" data-aos="fade-up" data-aos-delay="750" data-aos-duration="1500"
